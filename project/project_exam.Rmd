...
In addition to parameters estimates, the procedure taken by the the `rstan` package allow the possibility to generate in-sample replications of the goals scored by the home and visitor team during every match of the championship. These simulated values from the joint posterior predictive distribution can be used to compare these samples to the observed data.  
