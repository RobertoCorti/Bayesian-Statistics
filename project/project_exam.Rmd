...
In this way, for example, a team like AC Milan or Juventus that have always been in the top-6 positions in the last 5 campaigns prior to 1991, will have a $\mathbb{E}[\pi^{att}_{t,top}] = \mathbb{E}[\pi^{def}_{t,top}] = 6/8 \simeq  0.76$ . This prior information can help the model to "detect" which kind of team belong to one of the three categories, since historically teams that are used to finish at the top will also have more financial possibilities for acquiring the best players in the market.
